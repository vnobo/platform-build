package com.bootiful.gateway.client;
...
import com.bootiful.gateway.security.RegisterRequest;
import com.bootiful.gateway.security.TenantCutRequest;
...
public class AuthClient extends AbstractClient {
    ...
    public Mono<LoginSecurityDetails> changePassword(String username, String password) {
        return super.put("/user/manager/v1/change/password", Map.of("username", username,
                        "password", password, "newPassword", password),
                LoginSecurityDetails.class, new Object[1]);
    }
    ...
    public Mono<SimplerSecurityDetails> tenantCut(TenantCutRequest cutRequest) {
        return super.post("/oauth2/v1/tenant/cut", cutRequest, SimplerSecurityDetails.class, new Object[1]);
    }
