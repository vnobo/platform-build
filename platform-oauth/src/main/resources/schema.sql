...
comment on column se_users.name is '用户真实姓名';
comment on column se_users.id_card is '用户身份证ID';
comment on column se_users.email is '用户登录Email,系统认证唯一标识';
comment on column se_users.phone is '用户登录电话,系统认证唯一标识';
...
comment on column se_authorities.system is '区分每个系统不同的权限';
comment on column se_authorities.user_id is '登录用户ID';
...
comment on column se_groups.type is '类型0普通 10单位';
comment on column se_groups.system is '区分系统不同的';
...
comment on column se_group_authorities.id is '组ID';
comment on column se_group_authorities.authority is '组的权限';
comment on table se_group_authorities is '权限组权限认证表.';
...
comment on column se_group_members.group_id is '组id';
comment on column se_group_members.user_id is '用户名ID';
...
comment on column se_tenants.name is '租户名';
comment on column se_tenants.code is '租户名';
comment on column se_tenants.description is '租户描述';
comment on column se_tenants.address is '租户地址';
comment on column se_tenants.pid is '租户父级ID';
comment on table se_tenants is '租户用户关系表';
...
comment on column se_tenant_members.user_id is '用户ID';
comment on column se_tenant_members.tenant_id is '租户ID';
...
comment on column se_masses.tenant_id is '人民群众默认租户id,只有自己默认了设置租户ID';
comment on column se_masses.user_id is '人民群众登录信息id,只有用户登录注册后,认证成功';
comment on column se_masses.name is '人民群众真实姓名';
comment on column se_masses.id_card is '人民群众身份证ID';
comment on column se_masses.address is '人民群众联系地址';
comment on table se_masses is '人民群众信息表';