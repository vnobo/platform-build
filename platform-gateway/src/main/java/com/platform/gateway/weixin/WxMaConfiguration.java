    ...
    private final WxMaMessageHandler subscribeMsgHandler =
            (wxMessage, context, service, sessionManager) -> {
                service.getMsgService().sendSubscribeMsg(
                        WxMaSubscribeMessage.builder().templateId("此处更换为自己的模板id")
                ...
                configs.stream()
                        .map(
                                a -> {
                                    ...
                                    if (StringUtils.hasLength(this.properties.getHttpProxyHost())
                                            && !ObjectUtils.isEmpty(this.properties.getHttpProxyPort())) {
                                        config.setHttpProxyHost(this.properties.getHttpProxyHost());
                                        config.setHttpProxyPort(this.properties.getHttpProxyPort());
                                        if (StringUtils.hasLength(this.properties.getHttpProxyUsername())
                                                && StringUtils.hasLength(this.properties.getHttpProxyPassword())) {
